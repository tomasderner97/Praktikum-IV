...
def plot_fit_0A():
    ...
    upper_line = Line2D([0.464, 0.50], [upper_y, upper_y], lw=0.8, linestyle="-.", c="k", label="odečtení $2p$")
    ax.add_line(upper_line)

    lower_line = Line2D([0.464 - 0.02, 0.50 + 0.02], [lower_y, lower_y], lw=0.8, linestyle="--", c="k",
                        label="odečtení $2D$")
